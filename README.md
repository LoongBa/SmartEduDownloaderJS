...
不想每次复制粘贴代码？本仓库提供 **Chrome / Edge 浏览器插件**（Manifest V3）：打开教材页面右下角自动出现【教材】下载按钮，一键下载；扩展图标按教材详情页状态自动变色。

| 安装方式 | 链接 | 状态 |
|----------|------|------|
| 📦 **微软商店**（Edge Add-ons） | https://microsoftedge.microsoft.com/addons/ | 🚧 发布后更新 |
| 🔴 **谷歌商店**（Chrome Web Store） | 暂无 | ⏳ 筹备中 |
| 📁 **手动部署**（开发者模式） | [插件目录说明](extension/README.md) | ✅ 可用 |
